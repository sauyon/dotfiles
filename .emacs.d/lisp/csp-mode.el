...
(defvar csp-keywords '("if" "then" "else" "channel" "datatype"
...
(defun csp-indent-to (col)
  "Indent from current point to column col. Tabs will be converted to spaces unless csp-untabify is set to nil."
  (let ((oldpos (point)))
    (indent-to col)
    (if csp-untabify
